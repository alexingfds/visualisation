...
.enter().append("text")
  ...
  .style("fill-opacity", function(d) { return d.parent === root ? 1 : 1; })
  .style("display", function(d) { return d.parent === root ? "inline" : "inline"; })
  .style('fill',function(d){if(d.data.name.includes(query, 0)){if(d.data.name==query){return 'green'}else{return 'red'}}})
...
.style("fill-opacity", function(d) { return d.parent === root ? 1 : 1; })
.style("display", function(d) { return d.parent === root ? "inline" : "inline"; })
.style('fill',function(d){if(listlib.length>0){if(listlib.includes(d.data.name)){return 'green'}}})
.style("font-size",  function(d){if( listlib.includes(d.data.name)){return '17px'}})
.attr("id", function(d){if( listlib.includes(d.data.name)){return 'selectedstyle'}})
.text(function(d) { return d.data.name; })
